...
epoch = 1200
g_e = torch.load("/home/yuning/DL/Monument/models/pt2_g_e_{}.pt".format(epoch));g_e.eval()
g_d = torch.load("/home/yuning/DL/Monument/models/pt2_g_d_{}.pt".format(epoch));g_d.eval()
# dis = torch.load("/home/yuning/DL/Monument/models/dis_{}.pt".format(epoch));dis.eval()
print("NOTE: All model has been loaded")


# normal_imag_path = "/home/yuning/DL/Monument/pt1_data/pt1_train_img/Test_72/normal/"
