...
epoch = 1800
g_e = torch.load("/home/yuning/DL/Monument/models/g_e_{}.pt".format(epoch));g_e.eval()
g_d = torch.load("/home/yuning/DL/Monument/models/g_d_{}.pt".format(epoch));g_d.eval()
